    ...
    <div class="top_bar"> 
        ...
        <nav>
            <?php 
                ...
                $friend_request = new User($con, $userLoggedIn);
                $friendRequests = $friend_request->getNumberOfFriendRequests();
            ?>
           ...
           <a href="javascript:void(0);"
            ...
            <a href="javascript:void(0);" 
                onclick="getDropdownData('<?php echo $userLoggedIn; ?>', 'notification')">
            ...
            <a href="javascript:void(0);" 
                onclick="getDropdownData('<?php echo $userLoggedIn ?>', 'friend_request')">
                <i class="fa fa-users fa-lg"></i>
            </a>
