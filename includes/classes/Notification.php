<?php 
    ...
    class Notification{
        ...
        public function insertNotification($post_id, $user_to, $type) {
            ...
            $insert = mysqli_query($this->con, "INSERT INTO notifications VALUES ('',
        ...
        public function getNotification($data, $limit)
        {
            ...
            // Update if the user clicks the notification badge
            $update_viewed = mysqli_query($this->con, "UPDATE notifications 
                SET viewed='yes' WHERE user_to='$userLoggedIn'");


            $myNotification = mysqli_query($this->con, "SELECT * FROM notifications 
                WHERE user_to='$userLoggedIn'
                ORDER BY id DESC");

            if(mysqli_num_rows($myNotification) == 0 ){
            ...
            while($row = mysqli_fetch_array($myNotification)){
                ...
                $user_data = mysqli_query($this->con, "SELECT * FROM users 
                ...
                $return_string .= "
                    <a href='".$row['link']."'>
                        <div class='resultDisplay resultDisplayNotification' 
                            ...
                            <p id='grey' class='timestamp_smaller'> 
                                ".$time_message." </p> ".$row['message']."
                        </div>
                    </a>
                ";
            }
